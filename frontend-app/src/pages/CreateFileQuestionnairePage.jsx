                            ...
                            >
                                <Form.Group as={Row} className="mb-3" controlId="formBasicEmail">
                                    ...
                                    <Col size="lg">
                                        <Form.Control
                                            type="text"
                                            placeholder="Enter a name for your questionnaire"
                                            value={name}
                                            onChange={(e) => {
                                ...
                                <Form.Group as={Row} className="mb-3" controlId="formBasicEmail">
                                    ...
                                    <Col size="lg">
                                        <Form.Control
                                            style={{height: "100px"}}
                                            placeholder="Enter more details for students about questionnaire"
                                            type="textarea"
                                            value={description}
                                            onChange={(e) => {
                                ...
                                <Form.Group as={Row} className="mb-3" controlId="formBasicEmail">
                                    ...
                                    <Col size="lg">
                                        <Form.Control
                                            placeholder="Enter time duration for questionnaire"
                                            type="number"
                                            value={duration}
                                            onChange={(e) => {

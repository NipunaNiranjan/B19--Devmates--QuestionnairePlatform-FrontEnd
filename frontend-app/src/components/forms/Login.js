      ...
      <div className="container1">
        <div className="frame">
          <div className="nav">
            <ul className="links">
              <br /><br />
              <li className="signin-active" style={{color:"white"}}>Log In here</li>
            </ul>
          </div>
          <div ng-app ng-init="checked = false">
            <form className="form-signin" action method="post" name="form">
              <input className="form-styling" type="text" name="username" placeholder="User Name" required onChange={(e) => {
              ...
              <div className="btn-animate">
                <a className="btn-signin" href type="button" onClick={SignIn}>Login</a>
              </div>
              <br />
              ...
              <div className="btn-animate">
          <a className="btn-signin" type="button" href="/">Register Now</a>
        </div>
            </form>
          </div>
          <br /><br />
